...
from sparseBeamSearch import sparseLogRegModel
from sparseDiversePool import sparseDiversePoolLogRegModel
from rounding import starRaySearchModel

from utils import compute_logisticLoss_from_X_y_beta0_betas, get_all_product_booleans, get_support_indices, isEqual_upTo_8decimal, isEqual_upTo_16decimal, get_all_product_booleans
...
class RiskScoreClassifier:
    ...
    ## NEW FUNCTION FOR CLASSIFICATION REPORT ##

    ## GABISA ##

    def print_classification_metrics(self, X, y):
        y_pred = self.predict(X)
